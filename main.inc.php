...
add_event_handler('init', 'bratonien_tools_album_shares_bootstrap', EVENT_HANDLER_PRIORITY_NEUTRAL);
add_event_handler('loc_end_page_header', 'bratonien_tools_picture_navigation_assets');
add_event_handler('loc_end_picture', 'bratonien_tools_picture_navigation_render');
