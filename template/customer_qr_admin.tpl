  ...
  <div class="bratonien-grid">
    ...
    <div class="bratonien-card">
      ...
      <div class="bratonien-form-grid">
        ...
        <span class="bratonien-label">Jahresbereich</span><strong>{$CUSTOMER_QR.year_min}–{$CUSTOMER_QR.year_max}</strong>
    ...
    <div class="bratonien-card">
      ...
      <div class="bratonien-form-grid">
        ...
        <span class="bratonien-label">Im Standardjahr {$CUSTOMER_QR.default_year}</span><strong>{$CUSTOMER_QR.current_year_total}</strong>
      </div>
